		...
		if(src in usr.contents)
			if(usr.move)
				...
				if(prob(10/skill/skill/skill))
					usr<<"Your understanding of the Suiton: Suiryuudan no Jutsu has increased."
					skill+=1
				usr.firing=1
				src.Active=1
				...
				viewers(16) << "<font color=[usr.SayFont]>[usr] yells<font color = white>: Suiton: Suiryuudan no Jutsu!"
			...
			for(var/mob/M in get_step(usr,usr.dir))
				if((M.Ninjutsu+M.Resistance) <= (usr.Ninjutsu+usr.Control))
					...
					if(usr.move)
						usr.firing=1
						src.Active=1
						viewers(16) << "<font color=[usr.SayFont]>[usr] yells<font color = white>: Suiton: Suirou no Jutsu!"
						usr.MaxNinjutsu += (1 *0.001)
						usr.Chakra-=usr.MaxChakra*(0.45/skill)
						M.move=0
		...
		if(src in usr.contents)
			if(usr.move)
				...
				if(usr.Chakra<150)
					return
				if(prob(10/skill/skill/skill))
					usr<<"Your understanding of the Suiton: Daibakufu no Jutsu has increased."
					skill+=1
				usr.firing=1
				src.Active=1
				usr.MaxNinjutsu += (1 *0.001)
				...
				viewers(16) << "<font color=[usr.SayFont]>[usr] yells<font color = white>: Suiton: Daibakufu no Jutsu!"
		...
		if(src in usr.contents)
			if(usr.move)
				...
				if(usr.Chakra<usr.MaxChakra*(0.50/skill))
					return
				if(prob(10/skill/skill/skill))
					usr<<"Your understanding of the Goshokuzame no Jutsu has increased."
					skill+=1
				usr.firing=1
				src.Active=1
				usr.MaxNinjutsu += (1 *0.001)
				...
				viewers(16) << "<font color=[usr.SayFont]>[usr] yells<font color = white>: Goshokuzame no Jutsu!"
				usr.Jutsu_Gain()
				A.loc=usr.loc
				A.dir = usr.dir
				walk(A,usr.dir)
		...
		if(src in usr.contents)
			if(usr.move)
				...
				if(usr.Chakra<150)
					return
				if(prob(10/skill/skill/skill))
					usr<<"Your understanding of the Suiton: Baku Suishouha no Jutsu has increased."
					skill+=1
				usr.firing=1
				src.Active=1
				usr.MaxNinjutsu += (1 *0.001)
				...
				viewers(16) << "<font color=[usr.SayFont]>[usr] yells<font color = white>: Suiton: Baku Suishouha no Jutsu!"
		...
		if(src in usr.contents)
			if(usr.move)
				...
				if(usr.Chakra<50)
					return
				if(prob(10/skill/skill/skill))
					usr<<"Your understanding of the Suijinheki no Jutsu has increased."
					skill+=1
				usr.firing=1
				src.Active=1
				usr.MaxNinjutsu += (1 *0.001)
