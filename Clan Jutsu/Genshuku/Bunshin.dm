		...
		if(src in usr.contents)
			...
			if(bunshins<bunshinskill)
				if(prob(10/bunshinskill/bunshinskill/bunshinskill))
					usr<<"Your understanding of the Genshuku Bunshin no Jutsu has increased."
					bunshinskill+=1
				...
				src.Active=1
				viewers(16) << "<font color=[usr.SayFont]>[usr] yells<font color = white>: Genshuku Bunshin no Jutsu!"
